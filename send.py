...
device_id = "VL53L0X"  # Add device id
iot_hub_name = "IoT-Hub-Accounting-system"  # Add iot hub name
sas_token = "SharedAccessSignature sr=IoT-Hub-Accounting-system.azure-devices.net&sig" \
            "=DPS9EsV6QBvp0yjrYHtSBHlcfBj86U1AUvnY3YAIC8I%3D&se=1683212868&skn=iothubowner"  # Add sas token string
...
for x in range(10):
    ...
    client.publish("devices/{device_id}/messages/events/".format(device_id=device_id), payload=data_out1, qos=1,
                   retain=False)
